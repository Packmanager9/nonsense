            ...
            for (let t = pix.data.length - 4; t >= 0; t -= 4) {
                ...
                if (keysPressed['e']) {
                    ...
                    for (let g = 0; g < n.length; g++) {
                        if (Math.abs(n[g].t - TIP_engine.x) + Math.abs(n[g].k - TIP_engine.y) < max && n[g].r + n[g].b + n[g].g < 1 && n[nin].tapped != 1) {
                ...
                if (n.length > 0) {
                    ...
                    if (this.blocks[x][y].m >= 1 && this.blocks[x][y].impact != 1) {
                        ...
                        if (n[nin].r + n[nin].g + n[nin].b < 1 && pix.data[t] + pix.data[t + 1] + pix.data[t + 2] > 1 && n[nin].tapped != 1) {
                            n[nin].r = pix.data[t]
